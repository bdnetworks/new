...
export const allProjects: Project[] = [
  {
    ...
    category: 'ব্লগার থিম',
    price: 25,
    imageUrl: 'https://raw.githubusercontent.com/bdnetworks/new/refs/heads/main/img/openshop.png',
    demoUrl: '#',
    isFeatured: true,
  },
  {
    ...
    price: 45,
    imageUrl: 'https://find-sourav.netlify.app/Images/Projects/e-school/1.png',
    demoUrl: '#',
    isFeatured: true,
  },
  {
