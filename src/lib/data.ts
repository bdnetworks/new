...
export const allProjects: Project[] = [
  {
    ...
    category: 'ব্লগার থিম',
    price: 25,
    imageUrl: 'https://i.imgur.com/nvBIa6C.png',
    demoUrl: '#',
    isFeatured: true,
  },
  {
    id: 2,
    title: 'ব্লগার নিউজ পোর্টাল',
    description: 'ব্লগার দিয়ে তৈরি একটি সম্পূর্ণ ডাইনামিক নিউজ পোর্টাল। দ্রুত এবং SEO-ফ্রেন্ডলি।',
    category: 'ব্লগার থিম',
    price: 45,
    imageUrl: 'https://i.imgur.com/58FnVL1.png',
  ...
  },
  {
    ...
    price: 50,
    imageUrl: 'https://find-sourav.netlify.app/Images/Projects/wedding%20card/wedding%20front.png',
    demoUrl: '#',
    isFeatured: true,
  },
  {
    ...
    category: 'ই-কমার্স',
    price: 99,
    imageUrl: 'https://i.imgur.com/xtfq5q8.png',
    demoUrl: '#',
    isFeatured: true,
  },
  {
